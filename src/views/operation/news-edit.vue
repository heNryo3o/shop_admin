        ...
        <el-row :gutter="30">
          ...
          <el-col :span="7">
            <el-card class="box-card" shadow="hover">
              ...
              <div>
                <el-form-item>
                  <el-date-picker v-model="info.created_at" type="datetime" style="width: 230px;" placeholder="请选择发布时间" />
                </el-form-item>
              </div>
              <div class="edit-label" v-if="loaded">
                <span>封面图</span>
              </div>
              <single-upload :fileUrl="info.thumb_url" v-if="loaded" @uploaded="handleUploaded" />
              <div class="edit-label">
                <span>SEO设置</span>
              </div>
              <div>
